...
- paste the content of [Hydra Conf file](../../examples/env/hydra.yml)
...
- nano /etc/systemd/system/hydra.service and paste the content of [hydra.service](../../examples/systemd/hydra.service)
...
- add the webserver conf file, add https and enable it
    - [apache](../../examples/apache/oauth.conf)
    - [nginx](../../examples/nginx/oauth.domain)
...
- cp .example.env .env
- nano .env and add the .env with [your values](../../examples/env/sso.env). You can also add them to your .service file (next line) but a .env must be present (even empty) :
- sudo nano /etc/systemd/system/aurion-sso.service and add the content of the [service file](../../examples/systemd/aurion-sso.service)
- sudo systemctl daemon-reload
- sudo systemctl start aurion-sso.service
- sudo systemctl enable aurion-sso.service
- add the webserver conf file, add https and enable it
    - [apache](../../examples/apache/sso.conf)
    - [nginx](../../examples/nginx/sso.domain)
...
- nano /etc/systemd/system/cryptpad.service and paste the content of [cryptpad.service](../../examples/systemd/cryptpad.service)
- add the webserver conf file, add https and enable it
    - [apache](../../examples/apache/pad.conf)
    - [nginx](../../examples/nginx/pad.domain)

- nano /home/pad/cryptpad/config/sso.js and add the content of [sso file](../../examples/env/pad/sso.js)
...
- sudo nano /etc/systemd/system/bulwark-webmail.service and add the content of the [service file](../../examples/systemd/bulwark-webmail.service)
- nano .env.local and add the content of [.env.local file](../../examples/env/bulwark.env.local).
- sudo systemctl daemon-reload
- sudo systemctl enable --now bulwark-webmail
- add the webserver conf file, add https and enable it
    - [apache](../../examples/apache/web.conf)
    - [nginx](../../examples/nginx/web.domain)
...
- sudo nano .env and add the content of [.env file](../../examples/env/api.env)
...
- sudo nano /etc/systemd/system/aurion.service and add the content of [service file](../../examples/systemd/aurion.service)
- sudo systemctl daemon-reload
- sudo systemctl enable aurion
- sudo systemctl start aurion
- add the webserver conf file, add https and enable it
    - [apache](../../examples/apache/api.conf)
    - [nginx](../../examples/nginx/api.domain)
## Bridges
...
### Cryptpad
Nothing to do, it has been configured with "nano /home/pad/cryptpad/config/sso.js and add the content [sso file](../../examples/env/pad/sso.js)" Remember ?
## And now ?
